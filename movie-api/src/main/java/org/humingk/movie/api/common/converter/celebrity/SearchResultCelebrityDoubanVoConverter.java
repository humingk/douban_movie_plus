...
public interface SearchResultCelebrityDoubanVoConverter
    extends BaseConverter<SearchResultCelebrityDoubanVo, SearchResultCelebrityDoubanDo> {
  @Override
  @Mappings({
  ...
  SearchResultCelebrityDoubanVo to(SearchResultCelebrityDoubanDo searchResultCelebrityDoubanDo);
}
