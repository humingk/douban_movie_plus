...
CREATE TABLE `album_netease` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `total` (`total`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐专辑';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='影人别名';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='电影别名';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `artist_netease` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐歌手';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐歌手-专辑';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐歌手-歌曲';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `award_movie` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='电影奖项';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣影人';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `celebrity_douban_to_classic`
--

DROP TABLE IF EXISTS `celebrity_douban_to_classic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `celebrity_douban_to_classic` (
  `id_celebrity_douban` bigint unsigned NOT NULL COMMENT '豆瓣影人ID',
  `id_classic_douban` bigint unsigned NOT NULL COMMENT '豆瓣电影经典台词ID',
  PRIMARY KEY (`id_celebrity_douban`,`id_classic_douban`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影经典台词-影人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='IMDB影人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `celebrity_scene` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `name_en` (`name_en`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景影人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `classic_douban` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '豆瓣电影经典台词ID',
  `id_movie_douban` bigint unsigned NOT NULL DEFAULT '0' COMMENT '豆瓣电影ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影经典台词';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `comment_movie_douban` (
  ...
  KEY `content` (`content`(20))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影短评';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `comment_netease` (
  ...
  KEY `agree_vote` (`agree_vote` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐专辑热门评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `continent_scene` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `name_en` (`name_en`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='洲';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `country_scene` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `name_en` (`name_en`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='国家';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `image_celebrity_douban` (
  `id` bigint unsigned NOT NULL COMMENT '豆瓣影人图片',
  `id_celebrity_douban` bigint unsigned NOT NULL DEFAULT '0' COMMENT '豆瓣影人ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣影人图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `image_movie_douban` (
  ...
  KEY `sort` (`sort`),
  KEY `length` (`length` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29903 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景地点图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影-奖项';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movie_douban_to_celebrity_douban` (
  ...
  KEY `sort` (`sort`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影-影人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影-影评';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影-电影类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movie_imdb` (
  ...
  KEY `name_origin` (`name_origin`),
  KEY `id_movie_douban` (`id_movie_douban`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='IMDB电影';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='IMDB电影-影人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='IMDB电影-影片类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movie_netease` (
  ...
  KEY `sort` (`sort`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐电影';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movie_scene` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `name_en` (`name_en`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景电影';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景电影-场景影人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `permission` (
  ...
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景地点';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景地点-场景地点类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐歌单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `profession` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `name_en` (`name_en`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='影人职业';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='知乎问题';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='IMDB电影评分';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rate_movie_douban` (
  ...
  KEY `vote` (`vote` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影评分';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `review_movie_douban` (
  ...
  KEY `create_datetime` (`create_datetime` DESC),
  KEY `title` (`title`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影影评';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户角色';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scene` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `happen_time` (`happen_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scene_detail` (
  ...
  KEY `id_movie_scene` (`id_movie_scene`),
  KEY `happen_time` (`happen_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景详情';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景详情-场景影人';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `song_netease` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐歌曲';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐歌曲-专辑';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐歌曲-歌单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `state_scene` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `name_en` (`name_en`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='州/省';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影标签';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trailer_movie_douban` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_movie_douban` (`id_movie_douban`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影预告片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='电影类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `type_place_scene` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场景地点类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `type_resource` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='cccc';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `type_video` (
  ...
  KEY `name_zh` (`name_zh`),
  KEY `name_en` (`name_en`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='影片种类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_douban` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣电影经典台词-豆瓣用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣用户-电影';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='豆瓣用户-豆瓣影评';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_netease` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='网易云音乐用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `website_resource` (
  ...
  PRIMARY KEY (`id`),
  KEY `name_zh` (`name_zh`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='电影资源网站';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-02-19 12:57:07
