  ...
  <div id="wrapper">
    <div id="root" class="root">
      <div class="sc-gqjmRU hbWVez" >
        ...
        <div v-show="sResult.length!=0" class="_b6i42sib8" style="font: 12px Helvetica,Arial,sans-serif;line-height: 1.62;">
          <div class="_rvqzudtbb">
            <div v-if="sResult && sResult.length!=0" v-for="result in sResult">
                ...
                <div class="item-root">
                  ...
                  <div class="detail">
                    ...
                    <div class="meta abstract_2">
                       <span v-if="item.directors" v-for="(itemDirector,indexDirector) in item.directors">
                      ...
                      <span v-if="item.leadingactors"
                            v-for="(itemLeadingactor,indexLeadingactor) in item.leadingtactors">
                         {{itemLeadingactor.name}}{{indexLeadingactor === itemLeadingactor.length-1?"":" / "}}
                       </span>
                    </div>
