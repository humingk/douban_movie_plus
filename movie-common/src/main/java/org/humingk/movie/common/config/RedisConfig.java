...
public class RedisConfig extends CachingConfigurerSupport {
   ...
   *
   * <p>方法上添加注解@cacheable即可自动缓存到redis
   *
   * <p>其他注解:@cacheconfig @cachePut 更新 @cacheEvict 删除
   *
   * <p>spring2.0.2之后,配置redisTemplate无法影响@cacheable注解,需单独配置fastjson序列化
   *
   * @return
   */
  @Bean
   ...
   * <p>包括 set get 等方法
   *
   * <p>由默认的JDK序列化改为fastjson序列化
   *
   * <p>使用方式： 自动导入redisTemplate redisTemplate.opsForValue().get(),redisTemplate.opsForValue().set()
   *
   * @return
   */
