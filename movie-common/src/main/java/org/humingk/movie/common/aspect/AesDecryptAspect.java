...
public class AesDecryptAspect {
  ...
  /** 切点定义: 使用@AESDecrypt注解的类or方法 */
  @Pointcut(
      "@within(org.humingk.movie.common.annotation.AesDecrypt) || @annotation(org.humingk.movie.common.annotation.AesDecrypt)")
  public void aesDecryptPointCut() {}

  /**
   * 环绕通知: 对controller层方法请求参数解密
   *
   * @param joinPoint
   * @return
   */
