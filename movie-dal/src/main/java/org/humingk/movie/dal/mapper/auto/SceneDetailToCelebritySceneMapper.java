...
public interface SceneDetailToCelebritySceneMapper {
  ...
  int deleteByPrimaryKey(
      @Param("idSceneDetail") Long idSceneDetail, @Param("idCelebrityScene") Long idCelebrityScene);
  ...
  int updateByExampleSelective(
      @Param("record") SceneDetailToCelebrityScene record,
      @Param("example") SceneDetailToCelebritySceneExample example);
