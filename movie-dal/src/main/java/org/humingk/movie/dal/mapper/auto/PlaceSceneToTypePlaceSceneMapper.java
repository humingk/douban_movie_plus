...
public interface PlaceSceneToTypePlaceSceneMapper {
  ...
  int deleteByPrimaryKey(
      @Param("idPlaceScene") Long idPlaceScene, @Param("idTypePlaceScene") Byte idTypePlaceScene);
  ...
  int updateByExampleSelective(
      @Param("record") PlaceSceneToTypePlaceScene record,
      @Param("example") PlaceSceneToTypePlaceSceneExample example);
