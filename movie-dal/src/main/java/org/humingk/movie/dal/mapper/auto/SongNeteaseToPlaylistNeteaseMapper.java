...
import org.humingk.movie.dal.entity.SongNeteaseToPlaylistNetease;
import org.humingk.movie.dal.entity.SongNeteaseToPlaylistNeteaseExample;
...
public interface SongNeteaseToPlaylistNeteaseMapper {
  ...
  int deleteByPrimaryKey(
      @Param("idSongNetease") Long idSongNetease,
      @Param("idPlaylistNetease") Long idPlaylistNetease);
  ...
  SongNeteaseToPlaylistNetease selectByPrimaryKey(
      @Param("idSongNetease") Long idSongNetease,
      @Param("idPlaylistNetease") Long idPlaylistNetease);

  int updateByExampleSelective(
      @Param("record") SongNeteaseToPlaylistNetease record,
      @Param("example") SongNeteaseToPlaylistNeteaseExample example);
