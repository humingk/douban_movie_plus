...
public interface SongNeteaseToAlbumNeteaseMapper {
  ...
  int deleteByPrimaryKey(
      @Param("idSongNetease") Long idSongNetease, @Param("idAlbumNetease") Long idAlbumNetease);
  ...
  int updateByExampleSelective(
      @Param("record") SongNeteaseToAlbumNetease record,
      @Param("example") SongNeteaseToAlbumNeteaseExample example);
