...
public interface MovieImdbToTypeMovieMapper {
  ...
  int deleteByPrimaryKey(
      @Param("idMovieImdb") Long idMovieImdb, @Param("idTypeMovie") Short idTypeMovie);
  ...
  int updateByExampleSelective(
      @Param("record") MovieImdbToTypeMovie record,
      @Param("example") MovieImdbToTypeMovieExample example);
