...
import org.humingk.movie.dal.entity.MovieDoubanToCelebrityDoubanExample;
...
public interface MovieDoubanToCelebrityDoubanMapper {
  ...
  MovieDoubanToCelebrityDouban selectByPrimaryKey(
      @Param("idMovieDouban") Long idMovieDouban,
      @Param("idCelebrityDouban") Long idCelebrityDouban,
      @Param("idProfession") Byte idProfession);

  int updateByExampleSelective(
      @Param("record") MovieDoubanToCelebrityDouban record,
      @Param("example") MovieDoubanToCelebrityDoubanExample example);
