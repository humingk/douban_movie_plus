...
public interface UserDoubanToClassicDoubanMapper {
  ...
  int deleteByPrimaryKey(
      @Param("idUserDouban") String idUserDouban, @Param("idClassicDouban") Long idClassicDouban);
  ...
  UserDoubanToClassicDouban selectByPrimaryKey(
      @Param("idUserDouban") String idUserDouban, @Param("idClassicDouban") Long idClassicDouban);

  int updateByExampleSelective(
      @Param("record") UserDoubanToClassicDouban record,
      @Param("example") UserDoubanToClassicDoubanExample example);
