 ...
 * Oauth2认证授权服务配置
 *
 * <p>EnableAuthorizationServer: 声明为认证服务器,支持请求包括：
 *
 * <p>/oauth/authorize： 授权码模式认证授权接口
 *
 * <p>/oauth/token： 获取token
 *
 * <p>/oauth/confirm_access： 用户授权
 *
 * <p>/oauth/error： 认证失败
 *
 * <p>/oauth/check_token： 资源服务器用来校验token
 *
 * <p>/oauth/token_key： jwt模式下获取公钥
 *
 * @author humingk
 */
@Configuration
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
  ...
  @Autowired private MyOauth2Translator myOauth2Translator;
  ...
  public JwtAccessTokenConverter jwtAccessTokenConverter() {
    ...
    KeyStoreKeyFactory keyStoreKeyFactory =
        new KeyStoreKeyFactory(new FileSystemResource(keyLocation), keySecret.toCharArray());
